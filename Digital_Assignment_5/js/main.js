...
window.onload = function() {
    ...
    function create() {
        ...
        player = this.game.add.sprite(this.game.world.centerX, 475, 'player', 22);
        player.animations.add('right', [9,10,11], 10, true);
        player.animations.add('left', [27, 28, 29], 10, true);
        player.animations.add('idle', [22], 10, true);
    ...
    function update() {
        ...
        this.game.physics.arcade.collide(meteors, player, hurtPlayer, playerProcessHandler, this);
        if(gameReady){
